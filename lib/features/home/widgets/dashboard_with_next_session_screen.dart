...
/// Dashboard Professeur - Aucun cours aujourd'hui AVEC prochaine séance
class DashboardWithNextSessionScreen extends StatelessWidget {
  const DashboardWithNextSessionScreen({super.key});
